/*
  # Add Search Insights Function
  
  1. New Functions
    - get_search_insights: Analyzes search patterns and provides insights
    
  2. Changes
    - Adds function to analyze search terms, results, and success rates
    - Includes category analysis for search terms
